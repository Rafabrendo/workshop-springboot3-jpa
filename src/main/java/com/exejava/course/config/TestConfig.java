...
import com.exejava.course.entities.OrderItem;
import com.exejava.course.entities.Payment;
...
import com.exejava.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1); //Estou associando o pedido o1, chamando o metodo e passando o pay1 como argumento.
		
		orderRepository.save(o1); //estou salvando de novo, porém agora com o pagamento
